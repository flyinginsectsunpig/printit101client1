...
const TShirtDesigner: React.FC = () => {
    ...
    // Load t-shirts from backend on component mount
    useEffect(() => {
        fetchTshirts();
    }, []);
            ...
            <footer style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div>
                            <div style={{
                                ...
                                <span style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>TeeDesign Pro</span>
                            </div>
                    ...
                    <div style={{
                        ...
                        <p>&copy; 2024 TeeDesign Pro. All rights reserved. Made with ❤️ for creators.</p>
                    </div>
                </div>
            </footer>
        </div>
